...
public interface TripDao {
    ...
    List<Trip> getUpComing(String mail);
    ...
    @Query("SELECT * FROM Trip WHERE date_time=:date_time and email=:email")
    List<Trip> getTripsByDateTime(String date_time,String email);
